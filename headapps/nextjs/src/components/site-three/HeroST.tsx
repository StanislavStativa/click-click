...
export const Default = (props: PageHeaderSTProps) => {
  ...
  return (
    <section
      className={`relative flex items-center border-16 border-background ${props.params.styles}`}
      data-class-change
    >
      ...
      <div className="relative lg:container w-full lg:flex mx-auto z-20" ref={containerRef}>
        <div className="flex flex-col justify-center mt-8 lg:mt-0 lg:w-2/3 lg:min-h-[50rem] p-8 backdrop-blur-[20px] bg-[linear-gradient(136deg,_rgba(255,255,255,0.21)_2.61%,_rgba(255,255,255,0.42)_73.95%)]">
...
export const Centered = (props: PageHeaderSTProps) => {
  ...
  return (
    ...
    >
      ...
      <div className="relative lg:container w-full lg:flex mx-auto z-20" ref={containerRef}>
        <div className="lg:relative lg:left-1/6 flex flex-col justify-center mt-8 lg:mt-0 lg:w-2/3 lg:min-h-[50rem] p-8 backdrop-blur-[20px] bg-[linear-gradient(136deg,_rgba(255,255,255,0.21)_2.61%,_rgba(255,255,255,0.42)_73.95%)]">
...
export const SplitScreen = (props: PageHeaderSTProps) => {
  return (
    <section
      className={`relative bg-primary border-16 border-background ${props.params.styles}`}
      data-class-change
    >
