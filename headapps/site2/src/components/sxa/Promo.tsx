    ...
    return (
      ...
      >
        <div className="flex flex-col items-start justify-end h-full">
          <JssImage field={props.fields.PromoIcon} className="w-full h-auto object-cover" />
          <div className="flex-1 relative pt-4 px-6">
            ...
            />
            <JssRichText tag="div" className="text-base mb-4" field={props.fields.PromoText2} />
          </div>
          <Button
            variant="default"
        ...
        <div className="flex flex-col items-start justify-end">
          ...
          <div className="flex-1 relative pt-4 px-4 w-full justify-center text-center">
            <JssRichText
              ...
              field={props.fields.PromoText}
            />
            <JssRichText tag="div" className="mb-4" field={props.fields.PromoText2} />
          </div>
          <Button
            variant="link"
            size="lg"
